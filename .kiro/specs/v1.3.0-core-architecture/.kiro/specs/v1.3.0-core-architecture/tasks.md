...
- [x] 7.2 实现模型资产导入
  ...
  - 生成缩略图
  - _需求：6.2_
  - ✅ 已完成（阶段 7.2 - ModelImporter.ts 250+ 行）
...
- [x] 7.3 实现音频资产导入
  ...
  - 解析元数据
  - _需求：6.3_
  - ✅ 已完成（阶段 7.3 - AudioImporter.ts 130 行）

- [x] 7.4 实现 HDR 贴图导入
  - 解析 HDR 格式
  - 生成预览缩略图
  - _需求：6.4_
  - ✅ 已完成（阶段 7.4 - HDRImporter.ts 200+ 行）
...
- [x] 7.5 实现资产查询和删除
  ...
  - 实现资产删除
  - _需求：6.5, 6.7_
  - ✅ 已完成（阶段 7.5 - 高级查询和物理删除）

- [x] 7.6 实现本地文件系统访问
  - 使用 File System Access API
  - 实现文件选择器
  - _需求：6.6_
  - ✅ 已完成（阶段 7.6 - FileSystemService + 批量导入）
...
- [x]* 7.7 编写资产管线集成测试
  ...
  - 测试物理清理
  - _需求：6.1-6.7_
  - ✅ 已完成（阶段 7.7 - AssetPipeline.test.ts 15 个测试，100% 通过）
