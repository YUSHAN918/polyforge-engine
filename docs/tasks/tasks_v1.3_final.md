...
### 13.1 资产引用收集 (Smart Gathering)

- [x] 13.1.1 资产遍历器
  - ✅ 仅收集当前场景使用的资产 (HDR, Models, Audio)
  - _需求: 13.1_
...
### 13.2 Bundle 打包 (PFB Binary)

- [x] 13.2.1 实现 BundleSystem 二进制转码
  - ✅ 实现了 `packToBinary()` 核心方法
  - ✅ 自定义 PFB! 协议，支持高速装箱
  - _需求: 13.2_

- [x] 13.2.2 实现场景全量序列化
  - ✅ 包含实体和组件、WorldState 并行导出
  - _需求: 13.2_

- [x] 13.2.3 生成 .pfb 二进制生态包
  - ✅ 彻底解决 Base64 膨胀问题，支持 ArrayBuffer 直接打包
  - _需求: 13.2_

### 13.3 Bundle 加载

- [x] 13.3.1 实现异步流式加载
  - ✅ 实现了 `loadFromBinary()`，支持二进制片段提取
  - _需求: 13.3_

- [x] 13.3.2 资产 ID 强力对齐 (Kernel sync)
  - ✅ 扩展 `AssetRegistry.forceRegisterAsset` 保持引用闭环
  - _需求: 13.3_
...
- [x] 13.4.1 模型导出服务 (Integrated)
  - ✅ 整合自 v1.1.0，支持单体 GLB 导出
  - _需求: 13.4_
